...
for every_item in list:
    ...
    list2.insert(0,every_item)
print(f"List reversed: {list2}") #prints the text again for comparison perposes

#Last element moved to front: [5, 7, 5, 8, 9]
list.insert(0,list[-1]) #because list starts with zero, must be less than 1
del list[(len(list) - 1)] #because list starts with zero, must be less than 1
print(f"Last item first: {list}")